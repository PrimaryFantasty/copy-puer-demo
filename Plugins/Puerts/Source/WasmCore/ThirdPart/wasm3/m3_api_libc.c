...
m3ApiRawFunction(m3_libc_memset)
{
    m3ApiReturnType(int32_t)
        ...
        m3ApiGetArgMem(void*, i_ptr) m3ApiGetArg(int32_t, i_value) m3ApiGetArg(wasm_size_t, i_size)
...
m3ApiRawFunction(m3_libc_memmove)
{
    m3ApiReturnType(int32_t)
        ...
        m3ApiGetArgMem(void*, o_dst) m3ApiGetArgMem(void*, i_src) m3ApiGetArg(wasm_size_t, i_size)
...
m3ApiRawFunction(m3_libc_print)
{
    m3ApiReturnType(uint32_t)
        ...
        m3ApiGetArgMem(void*, i_ptr) m3ApiGetArg(wasm_size_t, i_size)
...
m3ApiRawFunction(m3_libc_printf)
{
    m3ApiReturnType(int32_t)
        ...
        m3ApiGetArgMem(const char*, i_fmt) m3ApiGetArgMem(wasm_ptr_t*, i_args)
